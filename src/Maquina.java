 ...
 */
     ...
     * Si hay stock, devuelve el cafe servido. Si no hay, muestra un mensaje de error y devuelve null.
     * 
...
/**
 * Muestra un mensaje de error indicando los ingredientes que faltan para preparar un café.
 * Se muestra por consola un mensaje que comienza con "❌ No se puede preparar el café por falta de:\n"
 ...
 * Se muestra un menú con los ingredientes actuales y se pide que seleccione uno.
...
/**
 * Muestra un menú para seleccionar un ingrediente y devuelve la selección realizada.
 * El menú muestra la lista de ingredientes y sus cantidades actuales.
 * Se pide al usuario que seleccione una opción y se devuelve la selección realizada.
 * La selección se realiza a través de un entero en rango de 1 a n, donde n es la cantidad
 * de ingredientes.
 * 
 ...
 * Se muestra un mensaje con el límite de capacidad de la máquina y se pide al usuario que
...
/**
 * Verifica si se puede rellenar la cantidad de un ingrediente sin exceder el límite de capacidad
 * de la máquina.
 * 
 ...
 * Pide al usuario que introduzca los gramos de cada ingrediente y el nombre del café.
 * Verifica si ya existe un café con ese nombre y, en caso de que no exista, crea la receta y la agrega a la lista de recetas.
